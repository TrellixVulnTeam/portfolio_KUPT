<template>
  <form
    ...
    action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSdyMVcsua4wZqFz8F-o4-pYiwxNw4eQXGLmStNr_9d7C0mnmA/formResponse"
    target="hideResult"
  >
    <FormItemInput
      v-model="form.name"
    ...
    <FormItemInput
      ...
      type="email"
      placeholder="Email*"
      name="entry.1051570597"
      required
    />
    <FormItemInput
      v-model="form.tel"
      type="tel"
      name="entry.1621031312"
      placeholder="Phone Number*"
    />
    <FormItemInput
      v-model="form.title"
      name="entry.1965561876"
      placeholder="Title*"
    />
    <FormItemTextarea
      v-model="form.message"
      placeholder="Message*"
      name="entry.1201844337"
      required
    />
    <div class="btn">
      ...
      <div class="msg txt-right">
        <p v-if="status === 'success'" class="msg-txt">
          お問い合わせを受付けました。いただいたメールアドレスにご連絡いたしますので、少々お待ちください。
        </p>
